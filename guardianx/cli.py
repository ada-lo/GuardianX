...
Includes commands: status, undo, logs, restore, backups, dashboard, config, help.
"""
...
def launch_dashboard():
    ...
    try:
        from guardianx.dashboard.app import app
        import uvicorn
...
Usage: python -m guardianx.cli <command> [arguments]
...
Examples:
  python -m guardianx.cli status
  python -m guardianx.cli undo 1234
  python -m guardianx.cli logs threats 10
  python -m guardianx.cli restore C:\\Users\\user\\Documents\\file.pdf
  python -m guardianx.cli backups 50
  python -m guardianx.cli dashboard
...
def main():
    ...
    if command == 'status':
        ...
        if len(sys.argv) < 3:
            print("Usage: python -m guardianx.cli undo <pid>")
        else:
        ...
        if len(sys.argv) < 3:
            print("Usage: python -m guardianx.cli restore <filepath>")
        else:
        ...
        print("Run 'python -m guardianx.cli help' for usage information")
